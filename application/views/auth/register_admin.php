  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        <div class="login100-form-title" style="background-image: url(https://pelatihanpariwisata.com/wp-content/uploads/2023/05/sukses-mengembangkan-cabang-laundry.jpg);">
          <span class="login100-form-title-1">
            Sign In
          </span>
        </div>
        <form class="login100-form validate-form" action="<?php echo base_url('Auth/aksi_register_admin') ?>" method="post">
          ...
          <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
            ...
            <input class="input100" type="text" name="email" placeholder="Enter email" value="<?php echo set_value('email') ?>" class="form-control">
                    <?= form_error('email', '<div class="text-danger">', '</div>'); ?>
            <span class="focus-input100"></span>
          </div>
