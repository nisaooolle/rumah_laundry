                ...
                <div class="baris">
                    <div class="col mt-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/aksi_tambah_paket_dc') ?>" method="post"
                                    class="form-input">
                                    <div class="form-grup">
                                    ...
                                    <div class="form-grup">
                                        ...
                                        <input type="number" name="kuantitas_dc" placeholder="Jumlah pakaian"
                                            autocomplete="off" id="berat" required>
                                    </div>

                                    <div class="form-grup">
                                        <label for="tarif">Tarif</label>
                                        <input type="text" name="tarif_dc" placeholder="Harga Paket" autocomplete="off"
                                            id="tarif" required>
                                    </div>
