                ...
                <div class="baris">
                    <div class="selamat-datang">
                        ...
                        <div class="col-header txt-right">
                            <a href="<?= base_url('admin/tambah_paket_dc') ?>" class="btn-lg bg-primary">+ Tambah
                                Paket</a>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button"
                                                            ...
                                                            <a class="text-light text-decoration-none"
                                                                href="<?php echo base_url('admin/edit_paket_dc/' . $dc->id_dc) ?>">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        </button>
                                                        <button type="button" onclick="hapus(<?php echo $dc->id_dc ?>)"
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "<?php echo base_url('admin/hapus_paket_dc/') ?>" + id;
                    });
                }
            });
        }
