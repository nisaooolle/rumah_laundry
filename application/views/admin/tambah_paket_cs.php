                ...
                <div class="baris">
                    <div class="col mt-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/aksi_tambah_paket_cs') ?>" method="post"
                                    class="form-input">
                                    <div class="form-grup">
                                        <label for="nama">Nama Paket</label>
                                        <input type="text" name="nama_cs" placeholder="Nama paket" autocomplete="off"
                                            id="nama" required>
                                    </div>
                                    ...
                                    <div class="form-grup">
                                        ...
                                        <input type="number" name="kuantitas_cs" placeholder="Jumlah pakaian"
                                            autocomplete="off" id="berat" required>
                                    </div>

                                    <div class="form-grup">
                                        <label for="tarif">Tarif</label>
                                        <input type="text" name="tarif_cs" placeholder="Harga Paket" autocomplete="off"
                                            id="tarif" required>
                                    </div>

                                    <div class="form-grup">
                                        <label for="ket_cs">Keterangan</label>
                                        <input type="text" name="keterangan_cs" value="-"
