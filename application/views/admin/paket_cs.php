                ...
                <div class="baris">
                    <div class="selamat-datang">
                        ...
                        <div class="col-header txt-right">
                            <a href="<?= base_url('admin/tambah_paket_cs') ?>" class="btn-lg bg-primary">+ Tambah
                                Paket</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-title card-flex">
                                ...
                                <div class="card-col txt-right">
                                    <a href="<?= base_url('admin/daftar_paket') ?>"
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_cs as $cs): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <!-- <a href="<?= base_url('admin/edit_paket_cs') ?>/<?= $cs->id_cs ?>"
                                                            class="btn btn-edit">Edit</a> -->
                                                        <button type="button"
                                                            class=" btn-sm btn-square btn-edit text-danger-hover-none">
                                                            <a class="text-light text-decoration-none"
                                                                href="<?php echo base_url('admin/edit_paket_cs/' . $cs->id_cs) ?>">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        </button>
                                                        <button type="button" onclick="hapus(<?php echo $cs->id_cs ?>)"
                                                            class="btn-sm btn-square btn-danger text-danger-hover-none">
                                                            <i class="fa-solid fa-trash"></i>
                                                        </button>
                                                        <!-- <a href="<?= base_url('admin/hapus_paket_cs') ?>/<?= $cs->id_cs ?>"
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = "<?php echo base_url('admin/hapus_paket_cs/') ?>" + id;
                    });
                }
            });
        }
