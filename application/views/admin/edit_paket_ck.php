                        ...
                        <div class="card">
                            <div class="card-title card-flex">
                                ...
                                <div class="card-col txt-right">
                                    <a href="<?= base_url('admin/paket_ck') ?>" style="color: white; text-decoration: none;"class="btn-xs bg-primary">Kembali</a>
                                </div>
                            </div>

                            <div class="card-body">
                                <?php foreach ($data_ck as $data): ?>

                                    <form action="<?php echo base_url('admin/aksi_edit_paket_ck') ?>" method="post"
                                        class="form-input">
                                        <input type="hidden" name="id_ck" value="<?= $data->id_ck ?>">
                                        <div class="form-grup">
                                            <label for="nama">Nama Paket</label>
                                            <input type="text" name="nama_paket_ck" placeholder="Nama paket"
                                                value="<?= $data->nama_paket_ck ?>" autocomplete="off" id="nama"
                                                required>
                                        </div>

                                        <div class="form-grup">
                                            <label for="wk">Waktu Kerja</label>
                                            <input type="text" name="waktu_kerja_ck" placeholder="Durasi Kerja"
                                                value="<?= $data->waktu_kerja_ck ?>" autocomplete="off" id="wk" required>
                                        </div>

                                        <div class="form-grup">
                                            <label for="berat">Berat Min (Kg)</label>
                                            <input type="text" name="kuantitas_ck" placeholder="Berat per-Kg"
                                                value="<?= $data->kuantitas_ck ?>" autocomplete="off" id="berat"
                                                required>
                                        </div>

                                        <div class="form-grup">
                                            <label for="tarif">Tarif</label>
                                            <input type="text" name="tarif_ck" placeholder="Harga Paket"
                                                value="<?= $data->tarif_ck ?>" autocomplete="off" id="tarif" required>
                                        </div>
