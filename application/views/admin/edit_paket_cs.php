                        ...
                        <div class="card">
                            <div class="card-title card-flex">
                                ...
                                <div class="card-col txt-right">
                                    <a href="<?= base_url('admin/paket_cs') ?>"style="color: white; text-decoration: none;" class="btn-xs bg-primary">Kembali</a>
                                </div>
                            </div>

                            <div class="card-body">
                                <?php foreach ($data_cs as $data): ?>

                                    <form action="<?php echo base_url('admin/aksi_edit_paket_cs') ?>" method="post"
                                        class="form-input">
                                        <input type="hidden" name="id_cs" value="<?= $data->id_cs ?>">
                                        <div class="form-grup">
                                            <label for="nama">Nama Paket</label>
                                            <input type="text" name="nama_cs" placeholder="Nama paket"
                                                value="<?= $data->nama_cs ?>" autocomplete="off" id="nama" required>
                                        </div>

                                        <div class="form-grup">
                                            <label for="wk">Waktu Kerja</label>
                                            <input type="text" name="waktu_kerja_cs" placeholder="Durasi Kerja"
                                                value="<?= $data->waktu_kerja_cs ?>" autocomplete="off" id="wk" required>
                                        </div>

                                        <div class="form-grup">
                                            <label for="berat">Berat Min (Kg)</label>
                                            <input type="text" name="kuantitas_cs" placeholder="Berat per-Kg"
                                                value="<?= $data->kuantitas_cs ?>" autocomplete="off" id="berat" required>
                                        </div>

                                        <div class="form-grup">
                                            <label for="tarif">Tarif</label>
                                            <input type="text" name="tarif_cs" placeholder="Harga Paket"
                                                value="<?= $data->tarif_cs ?>" autocomplete="off" id="tarif" required>
                                        </div>

                                        <div class="form-grup">
                                            <label for="ket_cs">Keterangan</label>
                                            <input type="text" name="keterangan_cs" value="<?= $data->keterangan_cs ?>"
