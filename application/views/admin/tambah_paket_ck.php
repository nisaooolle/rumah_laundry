                ...
                <div class="baris">
                    <div class="col mt-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/aksi_tambah_paket_ck') ?>" method="post"
                                    class="form-input">
                                    <div class="form-grup">
                                    ...
                                    <div class="form-grup">
                                        ...
                                        <input type="text" name="waktu_kerja_ck" placeholder="Durasi Kerja"
                                            autocomplete="off" id="wk" required>
                                    </div>

                                    <div class="form-grup">
                                        <label for="berat">Berat Min (Kg)</label>
                                        <input type="text" name="kuantitas_ck" placeholder="Berat per-Kg"
                                            autocomplete="off" id="berat" required>
                                    </div>

                                    <div class="form-grup">
                                        <label for="tarif">Tarif</label>
                                        <input type="text" name="tarif_ck" placeholder="Harga Paket" autocomplete="off"
                                            id="tarif" required>
                                    </div>
