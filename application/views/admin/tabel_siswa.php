                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        foreach ($orangtua as $row) : $no++ ?>
                            <tr onclick="navigateToPage('<?php echo base_url('admin/data_lengkap/') . $row->id ?>')" class="cursor-pointer bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400 ml-2%">
