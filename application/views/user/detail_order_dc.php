                    ...
                    <div class="col mt-2">
                        <div class="card-md">
                            <div class="card-title card-flex">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo base_url('admin/detail_order_dc') ?>">
                                        ...
                                        <table class="tb-detail_customer">
                                            <tr>
                                                <th>Nama</th>
                                                <td><input type="text" name="nama_pel_dc" disabled
                                                        value="<?= $data->nama_pel_dc ?>"></td>
                                            </tr>

                                            <tr>
                                                <th>Nomor Telepon</th>
                                                <td><input type="text" name="no_telp_dc" disabled
                                                        value="<?= $data->no_telp_dc ?>"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th>Order Masuk</th>
                                                <td><input type="text" name="tgl_masuk_dc" disabled
                                                        value="<?= $data->tgl_masuk_dc ?>"></td>
                                            </tr>

                                            <tr>
                                                <th>Diambil Pada</th>
                                                <td><input type="text" name="tgl_keluar_dc" disabled
                                                        value="<?= $data->tgl_keluar_dc ?>"></td>
                                            </tr>

                                            <tr>
                                                <th>Durasi Kerja</th>
                                                <td><input type="text" name="wkt_krj_dc" disabled
                                                        value="<?= $data->wkt_krj_dc ?>"></td>
                                            </tr>

                                            <tr>
                                                <th>Jenis Paket</th>
                                                <td><input type="text" name="jenis_paket_dc" disabled
                                                        value="<?= $data->jenis_paket_dc ?>"></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="tb-detail_order">
                                            ...
                                            <tr>
                                                <td><input type="text" name="berat_qty_dc" disabled
                                                        value="<?= $data->berat_qty_dc . ' Kg' ?>"></td>
                                        ...
                                        <div class="form-footer_detail">
                                            <div class="buttons">
                                                <button type="submit" name="bayar_dc" class="btn-sm bg-primary"><a
                                                        class="text-light text-decoration-none"
                                                        href="<?php echo base_url('user/bayar_order_dc/' . $data->or_dc_number) ?>">Bayar
                                                        Sekarang
                                                </button>
                                            </div>
                                        </div>
