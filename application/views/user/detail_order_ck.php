                    ...
                    <div class="col mt-2">
                        <div class="card-md">
                            <div class="card-title card-flex">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo base_url('user/bayar_order_ck') ?>">
                                        ...
                                        <div class="details">
                                            ...
                                            <p class="lead">
                                                <textarea name="keterangan_ck" disabled
                                                    class="txt-area">  <?= $data->keterangan_ck ?> </textarea>
                                            </p>
                                        </div>
                                        ...
                                        <div class="form-footer_detail">
                                            <div class="buttons">
                                                <button type="submit" name="bayar_ck" class="btn-sm bg-primary"><a
                                                        ...
                                                        href="<?php echo base_url('user/bayar_order_ck/' . $data->or_ck_number) ?>">Bayar
                                                        Sekarang
                                                </button>
                                            </div>
                                        </div>
