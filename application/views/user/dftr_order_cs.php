                                                        ...
                                                        <div class="widget-content p-0">
                                                            ...
                                                            <img width="40" class="rounded-circle"
                                                                ...
                                                                <div class="widget-content-left flex2">
                                                                    <?php echo $pesanan_terbaru->nama_pel_cs ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->or_cs_number ?>
                                                    </td>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->tgl_masuk_cs ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->jenis_paket_cs ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->wkt_krj_cs ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->jml_pcs ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <button type="button"
                                                            class=" btn-sm btn-square btn-edit text-danger-hover-none">
                                                            <a class="text-light text-decoration-none"
                                                                href="<?php echo base_url('user/detail_order_cs/' . $pesanan_terbaru->or_cs_number) ?>">
