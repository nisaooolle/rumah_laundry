                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-title card-flex">
                                <div class="card-col">
                                    <h2 class="judul-md">Order Dry Clean</h2>
                                </div>
                            </div>
                                                        ...
                                                        <div class="widget-content p-0">
                                                            ...
                                                            <img width="40" class="rounded-circle"
                                                                ...
                                                                <div class="widget-content-left flex2">
                                                                    <?php echo $pesanan_terbaru->nama_pel_dc ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->or_dc_number ?>
                                                    </td>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->tgl_masuk_dc ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->jenis_paket_dc ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->wkt_krj_dc ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <?php echo $pesanan_terbaru->berat_qty_dc ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <button type="button"
                                                            class=" btn-sm btn-square btn-edit text-danger-hover-none">
                                                            <a class="text-light text-decoration-none"
                                                                href="<?php echo base_url('user/detail_order_dc/' . $pesanan_terbaru->or_dc_number) ?>">
                                                                <i class="fas fa-solid fa-circle-info"></i>
                                                            </a>
                                                        </button>
                                                        <!-- <button type="button" onclidc="hapus(<?php echo $karyawan->id ?>)"
