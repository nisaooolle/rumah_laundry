    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-header ">
        ...
        <div class="card-payment">
            ...
            <?php foreach ($bayar as $data): ?>
                ...
                <form method="post" action="<?php echo base_url('user/bayar_dan_simpan_riwayat_cs/' . $data->or_cs_number) ?>">
                    <input type="hidden" name="or_cs_number" value="<?= $data->or_cs_number ?>">
                    <input type="hidden" name="nama_pel_cs" value="<?= $data->nama_pel_cs ?>">
                    <input type="hidden" name="no_telp_cs" value="<?= $data->no_telp_cs ?>">
                    <input type="hidden" name="alamat_cs" value="<?= $data->alamat_cs ?>">
                    <input type="hidden" name="jenis_paket_cs" value="<?= $data->jenis_paket_cs ?>">
                    <input type="hidden" name="wkt_krj_cs" value="<?= $data->wkt_krj_cs ?>">
                    <input type="hidden" name="jml_pcs" value="<?= $data->jml_pcs ?>">
                    <input type="hidden" name="harga_perpcs" value="<?= $data->harga_perpcs ?>">
                    <input type="hidden" name="tgl_masuk_cs" value="<?= $data->tgl_masuk_cs ?>">
                    <input type="hidden" name="tgl_keluar_cs" value="<?= $data->tgl_keluar_cs ?>">
                    <input type="hidden" name="tot_bayar" value="<?= $data->tot_bayar ?>">
                    <input type="hidden" name="keterangan_cs" value="<?= $data->keterangan_cs ?>">

                    <input type="text" name="nominal" required autofocus autocomplete="off"
                        value="<?= $data->tot_bayar ?>" placeholder="Nominal ex: '120000'">
                    <button type="submit" name="bayar">Bayar</button>
                    <!-- <button  type="submit" name="bayar"><a
                            class="text-light text-decoration-none"
                            href="<?php echo base_url('user/bayar_dan_simpan_riwayat_cs/' . $data->or_cs_number) ?>">Bayar
                    </button> -->
                </form>
            </div>
        <?php endforeach ?>
