               ...
               <div class="col mt-2">
                  <div class="card">
                     <div class="card-title card-flex">
                        <div class="card-col">
                           <h2>Cuci Dry Clean (Cuci Kering)</h2>
                        </div>

                        <div class="card-col txt-right">
                           <button type="submit" name="bayar_ck" class="btn-sm bg-primary"><a
                                 style="color: white; text-decoration: none;"
                                 href="<?= base_url('user/paket_dc') ?>">Kembali</a></button>
                        </div>
                     </div>

                     <div class="card-body">
                        <form action="<?php echo base_url('user/aksi_tambah_order_dc') ?>" method="post">
                           <div class="row-input">
                              <div class="col-form m-1">
                                 <div class="form-grup">
                                    <label for="nama">Nama Pelanggan</label>
                                    <input type="text" name="nama_pel_dc" placeholder="Nama lengkap" autocomplete="off"
                                       id="nama">
                                 </div>

                                 <div class="form-grup">
                                    <label for="no-telp">Nomor Telepon</label>
                                    <input type="text" name="no_telp_dc" placeholder="Nomor Telepon" autocomplete="off"
                                       id="no-telp">
                                 </div>
                              ...
                              <div class="col-form m-1">
                                 <div class="form-grup">
                                    ...
                                    <select name="jenis_paket_dc" id="pilih_paket">
                                       ...
                                       <?php foreach ($tb_dry_clean as $dc): ?>
                                 ...
                                 <div class="form-grup">
                                    <?php foreach ($tb_dry_clean as $dc): ?>
                                       <input type="hidden" name="wkt_krj_dc" autocomplete="off" id="waktu_kerja_dc"
                                          value="<?= $dc['waktu_kerja_dc'] ?>">
                                    <?php endforeach ?>
                                 </div>
                                 <div class="form-grup">
                                    <?php foreach ($tb_dry_clean as $dc): ?>
                                 ...
                                 <div class="form-grup">
                                    ...
                                    <input type="number" name="berat_qty_dc" placeholder="Berat (Kg)" autocomplete="off"
                                       id="kuantitas">
                                 </div>
